...
export const ExploratoryAnalysisIcon = (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <path className="fill-slate-200 opacity-40" d="M505 44c11 13.8 8.8 33.9-5 45L340 217c-11.4 9.1-27.5 9.4-39.2 .6L192.6 136.5 52 249c-13.8 11-33.9 8.8-45-5s-8.8-33.9 5-45L172 71c11.4-9.1 27.5-9.4 39.2-.6l108.2 81.1L460 39c13.8-11 33.9-8.8 45 5z" />
                </svg>
    )
