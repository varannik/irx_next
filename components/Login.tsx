              ...
              >
                <DialogPanel className="pointer-events-auto w-screen max-w-md">
                  ...
                  <div className="flex min-h-full flex-col items-center  justify-center sm:px-6 lg:px-8 gap-4">
                    ...
                    <p className="mt-4 text-balance text-sm sm:text-md font-semibold tracking-tight text-text-active ">
                    ...
                    <Link
                      ...
                      className="flex w-36 items-center justify-center gap-3 rounded-md bg-[#24292F] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F]"
                      >
